...
2. [Install Dutch, Belgium Language Pack](#2-how-to-install-hungarian-language-pack)
3. [How to active Dutch, Belgium language pack](#3-how-to-active-hungarian-language-pack)
...
## 3. How to active Dutch, Belgium language pack {#active}
